...
{
    // PNH premine: 1,000,000 PNH in block 1.
    // Placed in block 1, not genesis, because the genesis coinbase is
    // never added to the UTXO set and would be permanently unspendable.
    if (nHeight == 1)
        return 1000000 * COIN;
